                            ...
                            <div class="col-xl-6">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <input type="hidden" class="form-control" id="id" name="id" value="<?= $informasi->id ?>" readonly>
                                        ...
                                        <div class="mb-3">
                                                        ...
                                                        <textarea class="form-control" id="isi" name="isi" value="<?= $informasi->isi ?>" rows="5"><?= $informasi->isi ?></textarea>
                                                        <?= form_error('isi'); ?>
                                                      </div>
                                            <div>
