  ...
  <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    ...
                                    <h4 class="page-title">Edit Metode Deposit</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
                        ...
                        <div class="row justify-content-center">
                            <div class="col-xl-6">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="header-title"><b>Edit Metode Deposit</b></h4>
                                        <?= $this->session->flashdata('message') ?>
                                        <form action="" class="parsley-examples" method="post">
                                            <?php foreach($metode as $metode){ ?>
                                                <input type="hidden" class="form-control" id="id" name="id" value="<?= $metode->id ?>">
                                        ...
                                        <div class="mb-3">
                                                ...
                                                <select class="form-control" data-toggle="select2" data-width="100%" id="payment" name="payment">
                                                    <option value="<?= $metode->payment ?>" selected><?= $metode->payment ?></option>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <select class="form-control" data-toggle="select2" data-width="100%" id="type" name="type">
                                                     <option value="<?= $metode->type ?>" selected><?= $metode->type ?></option>
                                        ...
                                        <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" id="name" name="name" value="<?= $metode->name ?>">
                                                <?= form_error('name'); ?>
                                            </div>
                                            <div class="mb-3">
                                                <p class="mb-1 fw-bold text-muted">Bank</p>
                                                <select class="form-control" data-toggle="select2" data-width="100%" id="bank" name="bank">
                                                    <option value="<?= $metode->bank ?>" selected><?= $metode->bank ?></option>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="number" class="form-control" id="norek" name="norek" value="<?= $metode->norek ?>">
                                                <?= form_error('norek'); ?>
                                            </div>
                                            <div class="mb-3">
                                                        <label for="example-textarea" class="form-label">Note</label>
                                                        <textarea class="form-control" id="note" name="note" rows="4" value="<?= $metode->note ?>"><?= $metode->note ?></textarea>
                                                        <?= form_error('note'); ?>
                                                      </div>
                                                      <div class="mb-3">
                                                <label for="emailAddress" class="form-label">Minimal Deposit<span class="text-danger">*</span></label>
                                                <input type="number" class="form-control" id="min" name="min" value="<?= $metode->min_amount ?>">
                                                <?= form_error('min'); ?>
                                            </div>
                                            <div class="mb-3">
                                                <label for="emailAddress" class="form-label">Rate<span class="text-danger">*</span></label>
                                                <input type="text" class="form-control" id="rate" name="rate" value="<?= $metode->rate ?>">
                                                <?= form_error('rate'); ?>
                                            </div>
                                            <div>
